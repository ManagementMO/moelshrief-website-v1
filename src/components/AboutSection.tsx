        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-center">
          ...
          <div className="md:col-span-2 relative">
            <div className="relative">
              {/* Image border effect */}
              <motion.div 
                className="absolute inset-0 bg-gradient-to-br from-futuristic-purple via-futuristic-blue to-futuristic-purple rounded-2xl blur-sm"
                animate={{
                  opacity: [0.5, 0.8, 0.5],
                  scale: [1, 1.02, 1],
                }}
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 h-[480px]">
                <img 
                  src="/lovable-uploads/a169c866-c182-4c19-bc29-e9c7c0d3877b.png" 
                  alt="Mohammed Elshrief" 
                  className="w-full h-full object-contain bg-gradient-to-b from-futuristic-dark/40 to-futuristic-dark/90"
                />
            ...
            {/* Floating stats box */}
            <motion.div 
              className="glass-effect absolute -bottom-6 -right-6 p-4 rounded-xl md:block hidden"
          ...
          <div className="md:col-span-3">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              I'm Mohammed Elshrief, a Data Engineer and Analyst with expertise in designing and implementing end-to-end data solutions. 
