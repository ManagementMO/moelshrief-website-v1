...
const AboutSection = () => {
  ...
  return (
    <section 
      id="about" 
      ref={sectionRef}
      className="relative py-36 lg:py-44 overflow-hidden bg-black text-white"
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <Button
                  className="rounded-full bg-white text-black hover:bg-white/90 px-8 py-6 font-medium tracking-wide text-sm"
                ...
                <Button
                  variant="outline"
                  className="rounded-full border-white/20 hover:bg-white/10 px-8 py-6 font-medium tracking-wide text-sm"
