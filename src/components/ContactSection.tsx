                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <FuturisticButton
                        ...
                        variant="primary"
                        size="lg"
                        className="w-full bg-gradient-to-b from-black/50 to-black border-white/30 text-white hover:bg-white/10 hover:border-white/70 hover:text-white hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] focus:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all"
                        glowEffect
