...
const HeroSection = () => {
  ...
  return (
    <section 
      id="home" 
      ref={containerRef}
      className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-16 transition-colors duration-300"
    >
      {/* Background gradient */}
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div 
          className="absolute top-1/4 left-1/4 w-32 h-32 rounded-full bg-secondary/10 backdrop-blur-sm glass-effect"
          animate={{
            y: [0, -20, 0],
          }}
          transition={{ 
        ...
        <motion.div 
          className="absolute bottom-1/4 right-1/3 w-20 h-20 rounded-full bg-primary/10 backdrop-blur-sm glass-effect"
          animate={{
            y: [0, -15, 0],
          }}
          transition={{ 
      ...
      <div className="relative container mx-auto px-6 z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        ...
        >
          <div className="relative">
            <motion.div 
              className="text-xs font-mono tracking-wider text-muted-foreground uppercase mb-4"
            ...
            >
              <Button 
                className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-full px-8 py-6 text-sm font-medium tracking-wide"
              ...
              <Button 
                variant="outline" 
                className="rounded-full px-8 py-6 border-primary/20 text-sm font-medium tracking-wide hover:bg-primary/10"
      ...
      >
        <motion.div 
          className="w-[1px] h-10 bg-foreground/20"
